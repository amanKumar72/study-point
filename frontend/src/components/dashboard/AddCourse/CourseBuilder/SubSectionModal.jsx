...
export default function SubSectionModal({
  ...
  const isFormUpdated = () => {
    ...
    if (
      currentValues.lectureTitle !== modalData.name ||
        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input
              ...
              className="bg-gray-600 rounded-lg px-2 py-1 md:px-4 md:py-2 w-full"
            />
            {errors.lectureTitle && (
          ...
          <div className="flex flex-col space-y-2">
            ...
            <textarea
              ...
              className="bg-gray-600 rounded-lg px-2 py-1 md:px-4 md:py-2 resize-x-none min-h-[130px] w-full"
            />
            {errors.lectureDesc && (
              <span className="ml-2 text-xs tracking-wide text-pink-200">
