  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <label className="text-sm text-gray-50" htmlFor={name}>
        {label} <sup className="text-pink-200">*</sup> ( press enter or , to save tag)
      </label>
      ...
      <div className="flex w-full flex-wrap gap-y-2">
        ...
        {chips.map((chip, index) => (
          <div
            key={index}
            className="m-1 flex items-center rounded-full bg-yellow-300 px-2 py-1 text-sm text-black font-semibold"
          >
        ...
        <input
          ...
          className="form-style bg-gray-600 rounded-lg  px-2 py-1 md:px-4 md:py-2 w-full"
        />
      </div>
